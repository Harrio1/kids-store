...
<div class="container mt-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-light py-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Для новорожденных</li>
        </ol>
    </nav>
    ...
    <div class="row">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group-toggle" data-toggle="buttons">
                        @foreach([56, 62, 68, 74, 80, 86] as $size)
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="mb-0">Одежда для новорожденных</h1>
            ...
            <div class="banner mb-4">
                <div class="row align-items-center">
                    <div class="col-md-9">
                        <h4 class="mb-2">Скидка 20% на всю коллекцию для новорожденных</h4>
                        <p class="mb-0">Используйте промокод BABY2025 при оформлении заказа</p>
                    </div>
                ...
                @else
                    <div class="col-12">
                        <div class="alert alert-info">
                            Товары для новорожденных не найдены.
                        </div>
                    </div>
                @endif
            </div>
